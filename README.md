...
* 🌐 Development: C#, .NET Core, MVC, C++, JavaScript, Angular, Delphi, API, WCF, WPF.
* 💻 Tools: Embarcadeiro, Delphi, Docker, Jenkins, Visual Studio, Azure, AWS.
* 🖧 Network: Ubuntu Server, Debian, Servers, Permissions, Source Control, Users, Support.
* 💽 Others: Azure Logic Apps, BigData, Scrum, Agile, Git, Jira, TFS, Trello, PLC, EDI, Kepware.
